 ...
 * @author Soumita
 */
public class HitCountFilter implements Filter, Serializable {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("LoggerFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("LoggerFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig)
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("LoggerFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("LoggerFilter(");
