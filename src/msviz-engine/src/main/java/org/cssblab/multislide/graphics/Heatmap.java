...
public class Heatmap implements Serializable {
    ...
    */
    ...
    public Heatmap( FilteredSortedData data, 
        ...
        this.data = data;
        this.dataset_name = dataset_name;
        this.range_type = reference_heatmap.range_type;
        //double[] min_max = data.computeDataRange();
        double[] min_max = data.getMinMax(dataset_name);
        if(range_type.equals("data_bins")) {
            ...
            this.hist = new Histogram(reference_heatmap.hist.nBins, reference_heatmap.binningRangeStart, reference_heatmap.binningRangeEnd);
        }
        this.leaf_ordering = reference_heatmap.leaf_ordering;
        this.colormap = reference_heatmap.colormap;
        this.column_label = reference_heatmap.column_label;
        this.binningRangeStart = reference_heatmap.binningRangeStart;
        this.binningRangeEnd = reference_heatmap.binningRangeEnd;
        current_rasters = new HashMap <String, HeatmapContainer> ();
    }
    ...
    */
    ...
    public void assignBinsToRows(GlobalMapConfig global_map_config) {
        Float[][] expressions = data.getUnsortedExpressions(dataset_name);
        //int[][] expression_bin_nos = new int[data.nSamples][data.nFilteredGenes];
    ...
    public String buildMapImage_1 (int start, int end, String caller_id, int as_type) {
