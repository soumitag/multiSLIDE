...
public class BinaryTree implements Serializable {
    ...
    public BinaryTree (double[][] linkage_tree, int leaf_ordering_strategy) throws MultiSlideException {
        ...
        try {
            extractLeafOrdering(root_node_id);
             ...
             throw new MultiSlideException("Stack overflow in linkage tree.");
        } catch (Exception e) {
    ...
    public final void reorderChildNodes(int leaf_ordering_strategy) throws MultiSlideException {
        ...
        try {
            ...
            throw new MultiSlideException("StackOverflow during hierarchical clustering.");
        } catch (Exception e) {
            throw new MultiSlideException();
        }
    }
