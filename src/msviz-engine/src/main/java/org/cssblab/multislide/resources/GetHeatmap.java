...
public class GetHeatmap extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            parser.addParam("action", RequestParam.DATA_TYPE_STRING, RequestParam.PARAM_TYPE_REQUIRED, new String[]{"get_data", "get_global_data", "get_layout", "get_container_layout", "reset_heatmap", "get_map_config", "get_global_map_config"});
            if (!parser.parse()) {
            ...
            if(action.equalsIgnoreCase("get_data")){
                ...
                */
                ...
                int nGeneTags = analysis.data.fs_data.getGeneGroups().size();
                ...
                try {
                    HeatmapLayout map_layout = new HeatmapLayout(
                            analysis.global_map_config.getRowsPerPageDisplayed(), 
                            analysis.global_map_config.getColsPerPageDisplayed(), 
                            nPhenotypes, 
                            nGeneTags, 
                            ...
                            analysis.global_map_config.current_feature_start
                    );
                ...
                */
                ...
                try {
                    MapContainerLayout container_layout = new MapContainerLayout(analysis.data.fs_data.getNumDatasets());
