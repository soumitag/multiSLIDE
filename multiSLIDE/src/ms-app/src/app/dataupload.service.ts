...
export class DatauploadService {
  ...
  private baseUrl = "http://localhost:8080/msviz-engine/DataUploader";  // web api URL
  private createUrl = "http://localhost:8080/msviz-engine/CreateAnalysis";  // web api URL
  private removeUrl = "http://localhost:8080/msviz-engine/DataRemover";
  private previewUrl = "http://localhost:8080/msviz-engine/GetPreview";
  private metadataInfoUrl = "http://localhost:8080/msviz-engine/SetMetadataColumns";
